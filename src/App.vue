      ...
      <div class="editor_content">
        <div class="editor_area" @click="activateLayout" @contextmenu.prevent="handleRightMenu">
          <div class="editor_bg" :style="pageStyle">
            ...
            <drag v-for="(obj,index) in layout" :key="obj.type+index" :config="obj" @update="dragUpdate"
                  @activate="activateLayout" :layout="layout" @showStanderLine="showStanderLine"></drag>
          </div>
          ...
          <el-slider vertical :min="0.25" :max="3" :step="0.25" v-model="pageZoom"
          ...
          <el-tabs type="border-card" v-model="activeName">
            <el-tab-pane label="样式" name="style" v-if="showStyleTab">
                ...
                <el-form :inline="true" ref="style_text" label-width="53px" size="mini" :model="config.text"
                  ...
                  <div class="el-collapse-item__content">
                    <el-form-item label="旋转" prop="rotation">
                      <el-input-number v-model="config.text.rotation" controls-position="right" :min="-360"
                                       :max="360"></el-input-number>
                    </el-form-item>
                    <el-form-item label="透明" prop="alpha">
                      <el-input-number v-model="config.text.alpha" controls-position="right" :min="0.1" :max="1"
                    ...
                    <el-form-item label="字号" prop="fontSize">
                      <el-input-number v-model="config.text.fontSize" controls-position="right" :min="8"
                    ...
                    <el-form-item label="字间距" label-width="65px" prop="letterSpacing">
                      <el-input-number v-model="config.text.letterSpacing" controls-position="right" :min="0"
                                       :max="360"></el-input-number>
                    </el-form-item>
                  ...
                  <div class="el-collapse-item__content">
                    ...
                    <el-radio-group v-model="config.text.align">
                      <el-radio-button v-for="item in config.fontAlign" :label="item" :key="item"><i
                        :class="['fa','fa-align-'+item]"></i></el-radio-button>
                    </el-radio-group>
                    <el-radio-group v-model="config.text.valign">
                      <el-radio-button v-for="(item,key) in config.valignList" :label="key" :key="item"><i
                        :class="['fa','fa-rotate-90','fa-align-'+item]"></i></el-radio-button>
                    </el-radio-group>
                  </div>
                </el-form>
              </div>
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'barcode'">
                <el-form :inline="true" ref="style_barcode" label-width="53px" size="mini" :model="config.barcode">
                  ...
                  <div class="el-collapse-item__content">
                    <el-form-item label="x 轴" prop="left">
                      <el-input-number v-model="config.barcode.left" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="y 轴" prop="top">
                      <el-input-number v-model="config.barcode.top" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="宽度" prop="width">
                      <el-input-number v-model="config.barcode.width" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="高度" prop="height">
                      <el-input-number v-model="config.barcode.height" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                  </div>
                  ...
                  <div class="el-collapse-item__content">
                    <el-form-item label="透明" prop="alpha">
                      <el-input-number v-model="config.barcode.alpha" controls-position="right" :min="0.1" :max="1"
                                       :step="0.1"></el-input-number>
                    </el-form-item>
                  </div>
                </el-form>
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'qrcode'">
                <el-form :inline="true" ref="style_qrcode" label-width="53px" size="mini" :model="config.qrcode">
                  ...
                  <div class="el-collapse-item__content">
                    <el-form-item label="x 轴" prop="left">
                      <el-input-number v-model="config.qrcode.left" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="y 轴" prop="top">
                      <el-input-number v-model="config.qrcode.top" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="宽度" prop="width">
                      <el-input-number v-model="config.qrcode.width" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="高度" prop="height">
                      <el-input-number v-model="config.qrcode.height" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                  </div>
                  <div class="el-collapse-item__header">其他</div>
                  <div class="el-collapse-item__content">
                    <el-form-item label="透明" prop="alpha">
                      <el-input-number v-model="config.qrcode.alpha" controls-position="right" :min="0.1" :max="1"
                                       :step="0.1"></el-input-number>
                    </el-form-item>
                  </div>
                </el-form>
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'image'">
                <el-form :inline="true" ref="style_qrcode" label-width="53px" size="mini" :model="config.image"
                         :rules="config.image.rules">
                  <div class="el-collapse-item__header">位置排列</div>
                  <div class="el-collapse-item__content">
                    <el-form-item label="x 轴" prop="left">
                      <el-input-number v-model="config.image.left" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="y 轴" prop="top">
                      <el-input-number v-model="config.image.top" controls-position="right" :min="-1000"
                                       :max="2000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="宽度" prop="width">
                      <el-input-number v-model="config.image.width" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="高度" prop="height">
                      <el-input-number v-model="config.image.height" controls-position="right" :min="1"
                                       :max="1000"></el-input-number>
                    </el-form-item>
                  </div>
                  <div class="el-collapse-item__header">其他</div>
                  <div class="el-collapse-item__content">
                    <el-form-item label="透明" prop="alpha">
                      <el-input-number v-model="config.image.alpha" controls-position="right" :min="0.1" :max="1"
                                       :step="0.1"></el-input-number>
                    </el-form-item>
                    <el-form-item label="旋转" prop="rotation">
                      <el-input-number v-model="config.image.rotation" controls-position="right" :min="-360"
                                       :max="360"></el-input-number>
                    </el-form-item>
                  </div>
                </el-form>
            ...
            <el-tab-pane label="配置" name="config" v-if="showConfigTab">
              <div class="config_config" v-show="getActiveLayoutType === 'page'">
                ...
                <div class="el-collapse-item__content">
                  <el-form :inline="true" ref="config_config" label-width="53px" :model="config.page"
                    ...
                    <el-form-item label="宽度" prop="width">
                      <el-input-number :disabled="config.page.size!=''" v-model="config.page.width"
                                       controls-position="right" :min="100" :max="1000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="高度" prop="height">
                      <el-input-number :disabled="config.page.size!=''" v-model="config.page.height"
                                       controls-position="right" :min="100" :max="1000"></el-input-number>
                    </el-form-item>
                    <el-form-item label="水平偏移" prop="horizontalOffset" class="extrusion_line">
                      <el-input-number v-model="config.page.horizontalOffset" controls-position="right" :min="0"
                                       :max="config.page.width/2"></el-input-number>
                    </el-form-item>
                    <el-form-item label="垂直偏移" prop="verticalOffset" class="extrusion_line">
                      <el-input-number v-model="config.page.verticalOffset" controls-position="right" :min="0"
                                       :max="config.page.height/2"></el-input-number>
                    </el-form-item>
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'text'">
                ...
                <div class="el-collapse-item__content">
                  <el-form :inline="true" ref="config_text" label-width="53px" size="mini" :model="config.text"
                           :rules="config.text.rules">
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'barcode'">
                ...
                <div class="el-collapse-item__content">
                  <el-form :inline="true" ref="config_barcode" label-width="53px" size="mini" :model="config.barcode"
                           :rules="config.barcode.rules">
                    <el-form-item label="内容" prop="value" class="full-line">
                      <el-input type="textarea" :rows="2" v-model="config.barcode.value"
                                placeholder="请输入条形码内容"></el-input>
                    </el-form-item>
              ...
              <div class="config_config" v-show="getActiveLayoutType === 'qrcode'">
                ...
                <div class="el-collapse-item__content">
                  <el-form :inline="true" ref="config_qrcode" label-width="53px" size="mini" :model="config.qrcode"
                           :rules="config.qrcode.rules">
                    <el-form-item label="内容" prop="value" class="full-line">
                      <el-input type="textarea" :rows="2" v-model="config.qrcode.value"
    ...
    <el-dialog title="菜鸟打印\预览" :visible.sync="dialogVisible" width="550px">
      <el-form :model="printerConfig" inline label-width="80px">
        ...
        <el-form-item label="高度" class="extrusion_line">
          <el-input-number disabled v-model="printerConfig.paperSize.height"
                           controls-position="right"></el-input-number>
        </el-form-item>
        <el-form-item label="水平偏移" class="extrusion_line">
          <el-input-number disabled v-model="printerConfig.horizontalOffset" controls-position="right" :min="0"
                           :max="10"></el-input-number>
        </el-form-item>
        <el-form-item label="垂直偏移" class="extrusion_line">
          <el-input-number disabled v-model="printerConfig.verticalOffset" controls-position="right" :min="0"
                           :max="10"></el-input-number>
        </el-form-item>
      </el-form>
